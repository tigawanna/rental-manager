    ...
    >
      ...
      <ResponsiveGenericToolbar>
        <div className="flex h-full min-h-screen w-full flex-col items-center justify-center gap-10 p-5">
          ...
          <div className="mt-10 grid w-full max-w-6xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Link
              to="/dashboard/units"
              className="card bg-base-200 hover:bg-base-300 shadow-lg transition-all hover:scale-105"
            >
              <div className="card-body items-center text-center">
                <Building2 className="text-primary mb-2 size-12" />
            ...
            >
              <div className="card-body items-center text-center">
                <DollarSign className="text-primary mb-2 size-12" />
            ...
            >
              <div className="card-body items-center text-center">
                <UserCog className="text-primary mb-2 size-12" />
